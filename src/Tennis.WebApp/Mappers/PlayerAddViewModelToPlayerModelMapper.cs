...
{
    /// <summary>
    /// This represents the mapper entity between <see cref="PlayerAddViewModel"/> and <see cref="PlayerModel"/>.
    /// </summary>
    public class PlayerAddViewModelToPlayerModelMapper : BaseMapper
    {
        /// <summary>
