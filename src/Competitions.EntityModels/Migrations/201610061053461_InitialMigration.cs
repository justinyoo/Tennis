namespace Competitions.EntityModels.Migrations
{
    ...
    public partial class InitialMigration : DbMigration
    {
                ...
                c => new
                    {
                        ...
                        DateCreated = c.DateTimeOffset(nullable: false, precision: 7, defaultValueSql: "SYSDATETIMEOFFSET()"),
                        DateUpdated = c.DateTimeOffset(nullable: false, precision: 7, defaultValueSql: "SYSDATETIMEOFFSET()"),
                        Competition_CompetitionId = c.Guid(),
                    })
                .PrimaryKey(t => t.TeamId)
                .ForeignKey("dbo.Club", t => t.ClubId, cascadeDelete: true)
                .ForeignKey("dbo.Competition", t => t.Competition_CompetitionId)
                .Index(t => t.ClubId)
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Team", "Competition_CompetitionId", "dbo.Competition");
            ...
            DropForeignKey("dbo.CompetitionTeams", "TeamId", "dbo.Team");
            DropForeignKey("dbo.Team", "ClubId", "dbo.Club");
            DropForeignKey("dbo.CompetitionTeams", "CompetitionId", "dbo.Competition");
            DropForeignKey("dbo.Fixture", "ClubId", "dbo.Club");
            DropForeignKey("dbo.ClubPlayers", "PlayerId", "dbo.Player");
            DropForeignKey("dbo.ClubPlayers", "ClubId", "dbo.Club");
            DropIndex("dbo.Venue", new[] { "VenueId" });
            DropIndex("dbo.TeamPlayer", new[] { "TeamId" });
            DropIndex("dbo.TeamPlayer", new[] { "PlayerId" });
            DropIndex("dbo.Team", new[] { "Competition_CompetitionId" });
            DropIndex("dbo.Team", new[] { "ClubId" });
            DropIndex("dbo.CompetitionTeams", new[] { "TeamId" });
            DropIndex("dbo.CompetitionTeams", new[] { "CompetitionId" });
            ...
            DropIndex("dbo.ClubPlayers", new[] { "ClubId" });
            DropTable("dbo.Venue");
            DropTable("dbo.District");
            DropTable("dbo.TeamPlayer");
            DropTable("dbo.Team");
            DropTable("dbo.CompetitionTeams");
